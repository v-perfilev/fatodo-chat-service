...
public class InfoController {
    ...
    public ResponseEntity<List<ChatInfoDTO>> getAllChatInfoByIds(@RequestBody List<UUID> chatIdList) {
    ...
    public ResponseEntity<List<MessageInfoDTO>> getAllMessageInfoByIds(@RequestBody List<UUID> messageIdList) {
        UUID userId = SecurityUtils.getCurrentId().orElseThrow(UnauthorizedException::new);
